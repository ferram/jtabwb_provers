...
* [**g3c**](https://github.com/ferram/jtabwb_provers/tree/master/cpl_g3c) is
  a simple example of implementation of a prover for
...
* [**frj**](https://github.com/ferram/jtabwb_provers/tree/master/ipl_frj)
  is the implementation of the forward calculus FRJ(G) for
...
* [**f3ni**](https://github.com/ferram/jtabwb_provers/tree/master/ipl_f3ni)
  is the implementation of the O(n log n)-space decision procedure for
  IPL based on the duplication-free tableau calculus of
...
* [**g3ibu**](https://github.com/ferram/jtabwb_provers/tree/master/ipl_g3ibu)
  is the implementation of the calculus **Gbu** presented in
...
* [**g3ied**](https://github.com/ferram/jtabwb_provers/tree/master/ipl_g3ied)
  is the implementation of the proof-search procedure for the sequent
  calculus **G3i** using evaluations to avoid loop-checking presented
  in
...
* [**g3iswiss**](https://github.com/ferram/jtabwb_provers/tree/master/ipl_g3iswiss)
  implements the proof-search procedure for the sequent calculus
  **G3i** for IPL using Swiss histories to avoid loops presented in
...
* [**jfcube**](https://github.com/ferram/jtabwb_provers/tree/master/ipl_jfcube)
  implements the basic version of the *FCube* prover described in
...
* [**lsj**](https://github.com/ferram/jtabwb_provers/tree/master/ipl_lsj)
  is the proof-search procedure for the sequent calculus **LSJ** of
...
* [**nbu**](https://github.com/ferram/jtabwb_provers/tree/master/ipl_nbu)
  is the implementation of a goal-oriented proof-search procedure for
